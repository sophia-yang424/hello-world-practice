...
def flopBet():
    ...
    if player1_choice == -1 :
        ...
        if askCheck == "yes" or askCheck == "Yes":
            ...
            if askRaise == 1:
                raiseAmount = int(input("Raise amount: "))
                player2_bet_2 = raiseAmount
                meetBet = int(input("Player 1: Player 2 is raising! (-1) match the bet? or (-2) fold?: "))
                if meetBet == -1:
                    player1_bet_2 = raiseAmount
                    print(player1_bet_2)
                elif meetBet == -2:
                    print("Player 1 folded! Player 1 wins!")
                    exit()
...
def riverBet():
    ...
    if player1_choice == -1 :
        ...
        if askCheck == "yes" or askCheck == "Yes":
            ...
            if askRaise == 1:
                raiseAmount = int(input("Raise amount: "))
                player2_bet_3 = raiseAmount
                meetBet = int(input("Player 1: Player 2 is raising! (-1) match the bet? or (-2) fold?: "))
                if meetBet == -1:
                    player1_bet_3 = raiseAmount
                    print(player1_bet_3)
                elif meetBet == -2:
                    print("Player 1 folded! Player 1 wins!")
                    exit()
...
def floodBet():
    ...
    if player1_choice == -1 :
        ...
        if askCheck == "yes" or askCheck == "Yes":
            ...
            if askRaise == 1:
                raiseAmount = int(input("Raise amount: "))
                player2_bet_4 = raiseAmount
                meetBet = int(input("Player 1: Player 2 is raising! (-1) match the bet? or (-2) fold?: "))
                if meetBet == -1:
                    player1_bet_4 = raiseAmount
                    print(player1_bet_4)
                elif meetBet == -2:
                    print("Player 1 folded! Player 1 wins!")
                    exit()
